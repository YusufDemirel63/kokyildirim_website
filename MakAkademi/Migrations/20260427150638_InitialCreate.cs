...
namespace MakAkademi.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentLevel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationRequests_AvailableTimeSlots_SelectedSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableTimeSlots_Date_StartTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageViews_SessionKey_CreatedAt",
                table: "PageViews",
                columns: new[] { "SessionKey", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ReservationRequests_SelectedSlotId",
